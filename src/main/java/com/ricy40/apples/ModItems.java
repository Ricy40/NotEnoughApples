...
public class ModItems {
    ...
    public static final DeferredRegister<Item> ITEMS = DeferredRegister.create(ForgeRegistries.ITEMS, Apples.MODID);
    ...
    public static final RegistryObject<Item> APPLE_SWORD = registerItem("apple_sword",
            () -> new Item(new Item.Properties().food(ModFoods.APPLE_SWORD)));
